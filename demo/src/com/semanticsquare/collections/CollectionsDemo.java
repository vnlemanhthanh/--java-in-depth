...
public class CollectionsDemo {
	...
	// If not sorted results are undefined. Might perform an inefficient
	// linear search!!
	// For Sets: HashSet ~ O(1). TreeSet ~ O(log(n)), i.e., same efficiency
	// as binary search
	// Note: List.contains is O(n)
	System.out.println(
		"Is John There? : " + Collections.binarySearch(list, "John"));
	...
	// Others: <T> List<T> singletonList(T o) & <K,V> Map<K,V>
	...
	System.out
		.println("Is Anita there?: " + unmodifiable.contains("Anita"));
	...
	// ~ Check back on methods starting with name "checked" as they are
	// generics related
